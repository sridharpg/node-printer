...
#undef STATUS_PRINTER_ADD
    ...
    std::string parseJobObject(const cups_job_t *job, v8::Local<v8::Object> result_printer_job)
    {
        ...
        //Common fields
        result_printer_job->Set(MY_NODE_MODULE_CONTEXT_PRE V8_STRING_NEW_UTF8("id"), V8_VALUE_NEW(Number, job->id));
        result_printer_job->Set(MY_NODE_MODULE_CONTEXT_PRE V8_STRING_NEW_UTF8("name"), V8_STRING_NEW_UTF8(job->title));
        result_printer_job->Set(MY_NODE_MODULE_CONTEXT_PRE V8_STRING_NEW_UTF8("printerName"), V8_STRING_NEW_UTF8(job->dest));
        result_printer_job->Set(MY_NODE_MODULE_CONTEXT_PRE V8_STRING_NEW_UTF8("user"), V8_STRING_NEW_UTF8(job->user));
        ...
        result_printer_job->Set(MY_NODE_MODULE_CONTEXT_PRE V8_STRING_NEW_UTF8("format"), V8_STRING_NEW_UTF8(job_format.c_str()));
        ...
        if(i_status == 0)
        {
            ...
            result_printer_job_status->Set(MY_NODE_MODULE_CONTEXT_PRE i_status++, V8_STRING_NEW_UTF8(s.str().c_str()));
        }
        ...
        result_printer_job->Set(MY_NODE_MODULE_CONTEXT_PRE V8_STRING_NEW_UTF8("completedTime"), V8_VALUE_NEW_DATE(Date, creationTime));
        result_printer_job->Set(MY_NODE_MODULE_CONTEXT_PRE V8_STRING_NEW_UTF8("creationTime"), V8_VALUE_NEW_DATE(Date, creationTime));
        result_printer_job->Set(MY_NODE_MODULE_CONTEXT_PRE V8_STRING_NEW_UTF8("processingTime"), V8_VALUE_NEW_DATE(Date, processingTime));
    ...
    void populatePpdOptions(v8::Local<v8::Object> driver_options, ppd_file_t  *ppd, ppd_group_t *group)
    {
        ...
        MY_NODE_MODULE_ISOLATE_DECL
        v8::Local<v8::Object> ppd_options = v8::Local<v8::Object>::Cast(driver_options->Get(MY_NODE_MODULE_CONTEXT_PRE V8_STRING_NEW_UTF8("options")).ToLocalChecked());
        v8::Local<v8::Object> group_details = v8::Local<v8::Object>::Cast(driver_options->Get(MY_NODE_MODULE_CONTEXT_PRE V8_STRING_NEW_UTF8("groups")).ToLocalChecked());

        v8::Local<v8::Object> group_opts = V8_VALUE_NEW_DEFAULT_V_0_11_10(Object);
        group_details->Set(MY_NODE_MODULE_CONTEXT_PRE V8_STRING_NEW_UTF8(group->text), group_opts);
